...
public class Ripbytecode { //finds the best place for the Archon to move
    ...
    static Direction rip(RobotController rc) throws GameActionException {
        ...
        if(rc.onTheMap(l169)){
            if(!rc.isLocationOccupied(l169)){
                r169 = 10 + rc.senseRubble(l169);
                if(c169 > c154 + r169){
                    d169 = d154;
                    c169 = c154 + r169;
                }
        ...
        if(rc.onTheMap(l168)){
            if(!rc.isLocationOccupied(l168)){
                r168 = 10 + rc.senseRubble(l168);
                if(c168 > c154 + r168){
                    d168 = d154;
                    c168 = c154 + r168;
                }
        ...
        if(rc.onTheMap(l153)){
            if(!rc.isLocationOccupied(l153)){
                r153 = 10 + rc.senseRubble(l153);
                if(c153 > c168 + r153){
                    d153 = d168;
                    c153 = c168 + r153;
                }
        ...
        if(rc.onTheMap(l186)){
            if(!rc.isLocationOccupied(l186)){
                r186 = 10 + rc.senseRubble(l186);
                if(c186 > c171 + r186){
                    d186 = d171;
                    c186 = c171 + r186;
                }
        ...
        if(rc.onTheMap(l185)){
            if(!rc.isLocationOccupied(l185)){
                r185 = 10 + rc.senseRubble(l185);
                if(c185 > c170 + r185){
                    d185 = d170;
                    c185 = c170 + r185;
                }
        ...
        if(rc.onTheMap(l184)){
            if(!rc.isLocationOccupied(l184)){
                r184 = 10 + rc.senseRubble(l184);
                if(c184 > c169 + r184){
                    d184 = d169;
                    c184 = c169 + r184;
                }
        ...
        if(rc.onTheMap(l152)){
            if(!rc.isLocationOccupied(l152)){
                r152 = 10 + rc.senseRubble(l152);
                if(c152 > c138 + r152){
                    d152 = d138;
                    c152 = c138 + r152;
                }
    ...
    static Direction leastRubbleDir(RobotController rc) throws GameActionException {
